...
const event_card =
  "w-full bg-[#C44B6B] px-6 lg:px-10 py-6 lg:py-8 rounded-[20px] flex flex-col lg:flex-row items-start lg:items-center justify-start lg:justify-between gap-[20px]";
      ...
      <section className="w-full bg-white">
        <div className="container mx-auto px-5 py-8 lg:p-[100px]">
          <div className="flex gap-4 items-center mb-8">
            <p className="text-[24px] lg:text-[40px] text-fz_black_2 font-outfit font-medium">
              Our Events
            </p>
            ...
            <div className={event_card}>
              <div className="flex gap-5 items-start">
                <div className="flex flex-col text-fz_black_2 font-medium font-nunito_sans">
                  <p className="text-[20px] lg:text-[32px]">13</p>
                ...
                <div className="flex flex-col text-fz_black_2 font-medium">
                  ...
                  <h2 className="text-[18px] lg:text-[28px] font-bold text-fz_black_2 font-outfit">
                    A day with our wonderful children{" "}
                  </h2>
                </div>
              </div>
              <div>
                <div className="w-10 lg:w-14  h-10 lg:h-14 rounded-full bg-white flex justify-center items-center text-[18px] cursor-pointer">
                  <FaArrowRightLong />
                </div>
              </div>
            </div>
